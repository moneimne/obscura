...
public class CameraScript : MonoBehaviour {
    ...
    void Update() {
        ...
        GameObject.Find("rotating_part").transform.Rotate(GameObject.Find("rotating_part").transform.forward * Input.GetAxis("RightStickHorizontal") * -angular_speed * 1.3f, Space.World);
    }
}
